...
function App() {
  ...
  const apiRequest = async (event) => {
    ...
    axios
      .post(`https://artur-electron.herokuapp.com/users/`, {
        urls: urls,
        ...
        <div className="w3-card-4">
          ...
          <form>
            <div className="w3-text-brown">
              <ul style={{ paddingTop: "1%" }}>1º Cola o url para tracking</ul>
              <ul>2º Clica no Start tracking</ul>
            ...
            <p className="artur-p">
              <label className="w3-text-brown-artur">
                <b>
                  Tens direito a 2 produtos apenas! Após notificação volta a
                  fazer o processo todo!
                </b>
              </label>
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              <label className="w3-text-brown">
                <b>COMEÇA O TRACKING!</b>
              </label>
              <input
            ...
            <p>
              <button className="w3-btn artur-color" onClick={apiRequest}>
                Start tracking
              </button>
            </p>
          </form>
